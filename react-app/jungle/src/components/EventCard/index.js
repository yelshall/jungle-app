...
import {Text, ImageBackground, SafeAreaView, StyleSheet, Image} from 'react-native';

const Card = props => {
  const {event_name, image, event_description, event_host, event_location, event_date_time} = props.eventData;
  return (
