...
import { Avatar, Actionsheet, useDisclose } from "native-base";
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {student.fullName.firstName.charAt(0) +
              student.fullName.lastName.charAt(0)}
          </Text>
        </Avatar>
        <View
          style={{
      ...
      <Actionsheet isOpen={isOpen} onClose={onClose}>
        <Actionsheet.Content>
          ...
          >
            ...
            >
              <Text
                style={{ fontWeight: "bold", fontSize: 20, color: "#474747" }}
              >
                Log out
              </Text>
            </TouchableOpacity>
